...
function ChatLog:OnLoad()
	...
	Apollo.LoadSprites("INC.xml", "INC")
---	Apollo.RegisterSlashCommand("nlc", "OnNexTLabChatOn", self)
	self.tRecent = {}
...
function ChatLog:OnDocumentReady()
	...
	self.tAccountCurrencyValues =
	{
		[AccountItemLib.GetPremiumCurrency()] = AccountItemLib.GetAccountCurrency(AccountItemLib.GetPremiumCurrency()):GetAmount()
	}
	self.ktAccountCurrencyIncreased =
	{
		[AccountItemLib.GetPremiumCurrency()] = { strChatMessage = "ChatLog_AccountCurrencyIncrease", eSound = Sound.PlayUINCoinArrival }
	}
...
function ChatLog:OnAccountCurrencyChanged()
